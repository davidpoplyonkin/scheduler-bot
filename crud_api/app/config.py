...
INVOICE_VALIDITY_SECONDS = int(os.getenv("INVOICE_VALIDITY_SECONDS"))
INVOICE_CHECK_DELAY_SECONDS = int(os.getenv("INVOICE_CHECK_DELAY_SECONDS"))
INVOICE_CHECK_MAX_RETRIES = int(os.getenv("INVOICE_CHECK_MAX_RETRIES"))
